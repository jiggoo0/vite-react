...
📂 โครงสร้างโปรเจกต์
src/
├── App/ # RootApp.tsx = entry composition (providers, router, etc.)
├── Home/ # โมดูลฟีเจอร์หลัก (ฟอร์ม, เพจ, ฟีเจอร์เฉพาะ)
├── Layout/ # Layout หลัก: Navbar, Footer
├── Router/ # Routing + Guard
├── ThemeProvider/ # Theme context & hooks
├── assets/ # Static assets (โลโก้, รูปภาพ)
├── config/ # Config & ค่าคงที่
...
├── index.tsx # จุด entry ของระบบ (bootstrap React root)

> 📝 main.tsx และ App.tsx ถูกถอดออกแล้ว → ใช้ index.tsx + App/RootApp.tsx แทน
> 🛠 การพัฒนา
...
5. รันทดสอบ
   ...
   ⚡ สรุป: ตอนนี้ README สะท้อนโครงสร้างใหม่ที่ใช้ index.tsx + RootApp.tsx แล้ว และตัด main.tsx/App.tsx ออก
