...
const SalaryCertificate = () => {
  ...
  return (
    <div
      className="text-[16pt] leading-[1.6] font-[THSarabunNew] text-black bg-white
        w-[210mm] h-[297mm] max-w-full overflow-auto p-10 mx-auto shadow print:shadow-none print:border print:m-0 print:p-8"
    >
      {/* หัวกระดาษ */}
      ...
      <div className="whitespace-pre-line text-justify tracking-wide">
        ...
        เป็นพนักงานของบริษัทฯ โดยเริ่มปฏิบัติงานตั้งแต่วันที่ {data.startDate} จนถึงปัจจุบัน ดำรงตำแหน่ง{" "}
        {data.position} สังกัดแผนก {data.department}
