...
const SupportFAQ = () => {
    ...
    return (_jsx("section", { className: "py-16 bg-base-200 text-base-content", children: _jsxs("div", { className: "container mx-auto px-4", children: [_jsx("h2", { className: "text-3xl md:text-4xl font-extrabold text-center mb-12", children: "\u0E04\u0E33\u0E16\u0E32\u0E21\u0E17\u0E35\u0E48\u0E1E\u0E1A\u0E1A\u0E48\u0E2D\u0E22 (FAQ)" }), _jsx("div", { className: "space-y-4 max-w-3xl mx-auto", children: faqs.map((faq, idx) => (_jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-2xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300", children: [_jsxs("button", { onClick: () => toggle(idx), className: "w-full flex justify-between items-center p-5 text-left hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors", children: [_jsx("span", { className: "font-semibold text-lg md:text-xl", children: faq.question }), _jsx(motion.div, { animate: { rotate: openIndex === idx ? 180 : 0 }, transition: { duration: 0.3 }, children: _jsx(ChevronDownIcon, { className: "h-5 w-5 text-gray-600 dark:text-gray-300" }) })] }), _jsx(AnimatePresence, { initial: false, children: openIndex === idx && (_jsx(motion.div, { initial: { opacity: 0, height: 0 }, animate: { opacity: 1, height: "auto" }, exit: { opacity: 0, height: 0 }, transition: { duration: 0.3 }, className: "px-6 pb-6 text-gray-700 dark:text-gray-300 space-y-2 text-sm md:text-base leading-relaxed", children: Array.isArray(faq.answer)
                                        ? faq.answer.map((line, i) => _jsx("p", { children: line }, i))
                                        : _jsx("p", { children: faq.answer }) }, "content")) })] }, idx))) })] }) }));
};
