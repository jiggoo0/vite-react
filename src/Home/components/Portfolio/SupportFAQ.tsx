...
const faqs = [
  ...
  },
  {
    ...
    answer: 'ตอบ: ปกติใช้เวลาประมาณ 3-5 วันทำการ ขึ้นอยู่กับความซับซ้อนของเอกสารที่ต้องจัดเตรียม',
  },
  {
    question: 'ถาม: สามารถขอแก้ไขเอกสารได้ไหมหากพบข้อผิดพลาด?',
    answer: 'ตอบ: ได้ เรามีบริการแก้ไขและปรับปรุงเอกสารตามคำขอภายในระยะเวลาที่ตกลงกัน',
  },
  {
    question: 'ถาม: มีการรับประกันความถูกต้องของเอกสารหรือไม่?',
    answer: 'ตอบ: เรารับประกันความสมบูรณ์ของข้อมูล แต่ไม่สามารถรับประกันผลการอนุมัติของธนาคารได้',
  },
  {
  ...
  {
    question: 'ถาม: สามารถใช้บริการนี้สำหรับบุคคลทั่วไปหรือนิติบุคคลได้หรือไม่?',
    answer: 'ตอบ: บริการรองรับทั้งบุคคลธรรมดาและนิติบุคคล กรุณาแจ้งข้อมูลเพื่อประเมินความเหมาะสม',
  },
];
    ...
    <section id="support-faq" className="space-y-6">
      ...
      <ul className="space-y-4">
        {faqs.map(({ question, answer }, index) => (
          <li key={index} className="rounded-lg bg-base-200 p-4 shadow-sm" role="listitem">
